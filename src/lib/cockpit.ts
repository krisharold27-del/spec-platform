...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 56 of 56 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 1,734 tests, the security policies, and twenty customer journeys driven in a real browser.',
  },
  {
