...
export const CAPABILITIES: Capability[] = [
  ...
  C('jobs', 'kits', 'Kits & pre-builds', 'Bundles of items and labour you quote in one line.', 'partly', '/jobs?tab=catalogue builds a kit from items and labour and quotes it in one line. The pre-build job pack — SWMS, checklist, photos and van pick list — is not there.', 'job_management'),
