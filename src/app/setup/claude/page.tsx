    ...
    <Shell title="Register Claude" subtitle="Required before the journey opens.">
      <div className="max-w-2xl">
        <div className="callout text-sm">
          <div className="font-medium text-ink">Why this comes first</div>
          <p className="mt-1 text-ink-light">SPEC is delivered through Claude: it guides every step, explains why each KPI exists, and writes the monthly board output from your data. Registering Claude first is the first act of commitment — and it is what lets the rest run without a consultant in the room.</p>
        </div>
        <form action={registerClaude} className="mt-6 space-y-5">
          ...
          <div className="rounded-lg border bg-white p-4 text-sm text-ink-light">
            <div className="font-medium text-ink">What's needed</div>
          ...
          <button className="rounded-lg bg-rust px-5 py-2 text-white hover:bg-rust-dark">Save and continue</button>
