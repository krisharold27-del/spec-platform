...
export const QUESTIONS: Question[] = [
  ...
  { n: 90, group: 'Round 3', q: 'What happens if siteVIP goes down?', a: 'Phones keep working offline and everything syncs when it’s back. There’s a status page, and the owner gets a text.', where: 'Tech Day · status page' },
