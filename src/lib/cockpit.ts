...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 97 of 97 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 2,660 tests, the security policies, and 36 customer journeys driven in a real browser.',
  },
  {
