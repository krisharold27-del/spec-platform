...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 75 of 75 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 2,236 tests, the security policies, and 30 customer journeys driven in a real browser.',
  },
  {
