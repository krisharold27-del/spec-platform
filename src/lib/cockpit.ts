...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 103 of 103 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 2,910 tests, the security policies, and 41 customer journeys driven in a real browser.',
  },
  {
