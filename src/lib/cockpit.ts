...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 96 of 96 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 2,662 tests, the security policies, and 37 customer journeys driven in a real browser.',
  },
  {
