 ...
 * Conversation boards.
 *
 * Moved here from /boards on 16 September, when design export 3 gave that address to Boards — the
 * live artifacts a team pins and argues over. They share a word and nothing else, and folding one
 * into the other would have lost a piece of the method: this page is SPEC's reading OF the business,
 * built to raise one question and reach no verdict, while a board is the business's own artifact.
 *
 * Kept whole rather than merged, and reachable from Boards, because the distinction is the value.
 *
