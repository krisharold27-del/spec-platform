...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 85 of 85 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 2,365 tests, the security policies, and 33 customer journeys driven in a real browser.',
  },
  {
