...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 71 of 71 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 2,133 tests, the security policies, and 26 customer journeys driven in a real browser.',
  },
  {
