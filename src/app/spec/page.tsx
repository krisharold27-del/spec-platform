...
export const metadata = {
  title: 'SPEC — Safety, People, Earnings, Compliance',
  description: 'The GM-to-board operating system. siteVIP is its trades edition.',
  alternates: { canonical: '/spec' },
};

/**
 * SPEC's own front door, at /spec.
 *
 * Moved here from `/` on 23 September 2026, when the whole product came home to
 * www.sitevipapp.com and `/` became siteVIP, the trades edition (designs/siteVIP Landing.dc.html).
 * Nothing on this page was cut in the move: the problem box, the reading, the proof and the price
 * are all here, and the siteVIP page links to it ("siteVIP is the trades edition of SPEC").
 *
 * SPEC has two pages that matter and this was the first of them:
 *
 *   /spec (was /)   this, for anybody who has not signed in.
      ...
      */}
      <nav className="border-b border-ink/10">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-x-6 gap-y-2 px-6 py-3">
          <Link href="/spec" className="flex items-center gap-2.5 font-serif text-xl text-ink">
            <SpecMark size={44} />
            SPEC
          </Link>
          {/* The trades edition, which now owns the bare address. */}
          <Link href="/" className="label-caps hover:text-rust">siteVIP for trades</Link>
      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        */}
        ...
        >
          ...
          {/* 20ch, as the design draws it. It was briefly 30 while a two-sentence headline was on
              the page; the short one is back, and this measure was drawn around it. */}
