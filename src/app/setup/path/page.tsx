  ...
  return (
    ...
    >
      <div className="grid gap-4 md:grid-cols-2">
        <div className="flex flex-col rounded-lg border border-ink/10 bg-surface p-6">
          <div className="label-caps">On your own</div>
          <div className="mt-1 font-serif text-2xl text-ink">You work through it</div>
        ...
        <div className="flex flex-col rounded-lg border border-ink/10 bg-surface p-6">
          ...
          <div className="mt-1 font-serif text-2xl text-ink">We walk it with you</div>
          <p className="mt-3 flex-1 text-sm leading-relaxed text-ink-light">
          ...
          <form action={requestProgram} className="mt-4">
            {tenant.programRequestedAt
              ? <span className="text-sm text-sage-800">Requested — SPEC Business Solutions will be in touch. You can keep building in the meantime.</span>
