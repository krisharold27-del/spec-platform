...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 37 of 37 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 1,452 tests, the security policies, and nineteen customer journeys driven in a real browser.',
  },
  {
