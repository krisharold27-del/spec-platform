...
const ADDED_SINCE: { key: string; label: string; why: string }[] = [
  ...
  },
  {
    ...
    why: 'Two of the workflow map\u2019s last holes, closed together because they are the same shape: money that leaves because nothing said it was going. A builder\u2019s agreed schedule typed from memory drifts, and only ever one way; plant left on hire past the job that needed it turns up weeks later on an invoice nobody connects to the job. Kris, 25 September: everything must be done.',
  },
];
