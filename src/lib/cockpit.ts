...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 92 of 92 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 2,574 tests, the security policies, and 34 customer journeys driven in a real browser.',
  },
  {
