...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 36 of 36 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 1,270 tests, the security policies, and seventeen customer journeys driven in a real browser.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'A backup nobody has restored is a belief, not a backup. npm run restore-drill takes one, puts it back onto a separate server and compares every row count — proven on 26 tables and 77,207 rows. It has NOT been run against the live database, and it is not scheduled: it was automated, cried wolf twice about faults in itself, and was removed rather than left to erode trust in every other alarm. Run it deliberately when this answer is wanted.',
  },
];
