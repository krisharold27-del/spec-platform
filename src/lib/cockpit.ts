...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 104 of 104 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 2,947 tests, the security policies, and 43 customer journeys driven in a real browser.',
  },
  {
