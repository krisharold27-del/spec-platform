...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 74 of 74 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 2,217 tests, the security policies, and 28 customer journeys driven in a real browser.',
  },
  {
