...
| What | Evidence |
|---|---|
| The engine's arithmetic | 2417 tests across 137 files. Pillar, role and team maths, the 90% rule, incentive ceilings, the deduction and its cap, the seven statuses, the rule of 8 — all measured against `designs/the-rules.md` |
