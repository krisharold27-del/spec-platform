...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 70 of 70 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 1,973 tests, the security policies, and 24 customer journeys driven in a real browser.',
  },
  {
