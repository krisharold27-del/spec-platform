...
export const SCALE_CHECKS: ScaleCheck[] = [
  {
    ...
    evidence: 'Multi-tenant data isolation, enforced in application code, proven by tests/tenant-isolation.test.ts, and again by row-level security on 106 of 106 tables.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'npm run check — 2,958 tests, the security policies, and 44 customer journeys driven in a real browser.',
  },
  {
